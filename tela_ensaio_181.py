...
mult = 0
Pausa = False
idt = 'DNIT181-' #identificador do ensaio no banco de dados
...
class BottomPanel(wx.Panel):
    ...
    #--------------------------------------------------
        ...
        def MR(self, event):
            ...
            if self._fase > 0:
                if modeADM == True:
                    threadConection = SaveThread.SaveThreadADM(idt+"MR-"+str(self._fase), xz1, yz1, yt1, yz2, yt2, pc1, pg1, REFERENCIA1, REFERENCIA2)
...
class TelaRealizacaoEnsaioDNIT181(wx.Dialog):
    #--------------------------------------------------
        def __init__(self, *args, **kwargs):
            wx.Frame.__init__(self, parent = None, title = 'EDP - DNIT 181/2018ME - Tela_Ensaio_Beta', size = (1000,750), style = wx.MAXIMIZE_BOX | wx.MINIMIZE_BOX | wx.SYSTEM_MENU | wx.CLOSE_BOX | wx.CAPTION)
...
if __name__ == "__main__":
	app = wx.App()
	frame = TelaRealizacaoEnsaioDNIT181(None)
	frame.ShowModal()
	app.MainLoop()
