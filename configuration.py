...
class Page02(wx.Panel):
        ...
        def __init__(self, parent, id):
                ...
                self.CicloDP = wx.TextCtrl(self, -1, str(self.lista[1]), (245,53), (80,-1), wx.TE_CENTRE)
...
class Page03(wx.Panel):
        ...
        def __init__(self, parent, id):
                ...
                self.CicloMR = wx.TextCtrl(self, -1, str(self.lista[0]), (245,23), (80,-1), wx.TE_CENTRE)
                self.CicloMR.Disable()
                texto2 = wx.StaticText(self, -1, "erro máximo entre as leituras [%] =", (57,55), (-1,-1), wx.ALIGN_RIGHT)
                self.erro = wx.TextCtrl(self, -1, str(self.lista[1]), (245,53), (80,-1), wx.TE_CENTRE)
                self.erro.Disable()
