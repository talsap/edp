                ...
                if identificador in cond:
                    ...
                    if diametro!='' and altura!='':
                        if diametro>0 and altura>0:
                            ...
                            bancodedados.data_save_dados_134(identificador, tipo, cp, teordeumidade, pesoespecifico, umidadeotima, energiacompactacao, graucompactacao, data, amostra, diametro, altura, obs)
                            self.Close(True)
                            if tipo == 0:
                                tipoE = True
                            if tipo == 1:
