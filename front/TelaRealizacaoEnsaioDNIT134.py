            ...
            if Fase == 'CONDICIONAMENTO':
                ...
                if self._fase > 0:
                    if VETOR_COND[self._fase][1] != VETOR_COND[self._fase - 1][1] and self.AVANCA == False:
                        threadConection = DinamicaThread.DinamicaThreadOne(VETOR_COND[self._fase][1], VETOR_COND[self._fase-1][1], Diam)
                    ...
                    if VETOR_COND[self._fase][0] != VETOR_COND[self._fase - 1][0]:
                        ...
                        threadConection = DinamicaThread.DinamicaThreadTwo(VETOR_COND[self._fase][0], self.DINAMICA1_ANTERIOR)
                        dlgC2 = My.MyProgressDialog(3)
                        dlgC2.ShowModal()

                    if self.AVANCA == True:
                        threadConection = DinamicaThread.DinamicaThreadOne(VETOR_COND[self._fase][1], self.DINAMICA2_ANTERIOR, Diam)
                        dlgC1 = My.MyProgressDialog(3)
                        dlgC1.ShowModal()
                        self.DINAMICA2_ANTERIOR = VETOR_COND[self._fase][1]
                        time.sleep(.5)
                    ...
                    threadConection = DinamicaThread.DinamicaThreadOne(VETOR_COND[self._fase][1], 0, Diam)
                    dlgC1 = My.MyProgressDialog(3)
                    dlgC1.ShowModal()
                    time.sleep(.5)
                    #threadConection = MotorThread.MotorThread(VETOR_COND[self._fase][0])
                    threadConection = DinamicaThread.DinamicaThreadTwo(VETOR_COND[self._fase][0], 0)
                    dlgC2 = My.MyProgressDialog(3)
                    dlgC2.ShowModal()
            ...
            if Fase == 'MR':
                ...
                if self._fase > 0:
                    if VETOR_MR[self._fase][1] != VETOR_MR[self._fase - 1][1] and self.AVANCA == False:
                        threadConection = DinamicaThread.DinamicaThreadOne(VETOR_MR[self._fase][1], VETOR_MR[self._fase-1][1], Diam)
                        dlgC1 = My.MyProgressDialog(3)
                        dlgC1.ShowModal()
                    ...
                    if VETOR_MR[self._fase][0] != VETOR_MR[self._fase - 1][0] and self.AVANCA == False:
                        ...
                        threadConection = DinamicaThread.DinamicaThreadTwo(VETOR_MR[self._fase][0], self.DINAMICA1_ANTERIOR)
                        dlgC2 = My.MyProgressDialog(3)
                        dlgC2.ShowModal()

                    if self.AVANCA == True:
                        threadConection = DinamicaThread.DinamicaThreadOne(VETOR_MR[self._fase][1], self.DINAMICA2_ANTERIOR, Diam)
                        dlgC1 = My.MyProgressDialog(3)
                        dlgC1.ShowModal()
                        self.DINAMICA2_ANTERIOR = VETOR_MR[self._fase][1]
                        time.sleep(.5)
                    ...
                    threadConection = DinamicaThread.DinamicaThreadOne(VETOR_MR[self._fase][1], 0, Diam)
                    dlgC1 = My.MyProgressDialog(3)
                    dlgC1.ShowModal()
                    time.sleep(.5)
                    #threadConection = MotorThread.MotorThread(VETOR_MR[self._fase][0])
...
class BottomPanel(wx.Panel):
    ...
    #--------------------------------------------------
        ...
        def pressao_zero(self, p2Sen ,p1Sen):
            ...
            threadConection = DinamicaThread.DinamicaThreadTwoZero(0, p2Sen) 
